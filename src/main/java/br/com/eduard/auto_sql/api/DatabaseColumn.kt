package br.com.eduard.auto_sql.api

import br.com.eduard.auto_sql.api.annotations.ColumnJson
import br.com.eduard.auto_sql.api.annotations.ColumnName
import br.com.eduard.auto_sql.api.annotations.ColumnNullable
import br.com.eduard.auto_sql.api.annotations.ColumnPrimary
import br.com.eduard.auto_sql.api.annotations.ColumnRelation
import br.com.eduard.auto_sql.api.annotations.ColumnSize
import br.com.eduard.auto_sql.api.annotations.ColumnType
import br.com.eduard.auto_sql.api.annotations.ColumnUnique
import br.com.eduard.auto_sql.api.annotations.ColumnValue
import br.com.eduard.auto_sql.api.annotations.TableData
import br.com.eduard.auto_sql.customTypes
import br.com.eduard.auto_sql.util.Extra
...
class DatabaseColumn<T : Any>(val table: DatabaseTable<T>, val field: Field, val engine: DatabaseEngine) {
    ...
    val isBoolean = (wrapperType == Boolean::class.java)
    val isNumber
